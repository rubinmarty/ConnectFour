...
var _user$project$Grid$genericFold = F7(
	function (foldh, foldv, combine, combineRows, base, baseRow, grid) {
		var foldRow = A2(foldh, combine, base);
		var foldAndCombineRow = F2(
			function (row, acc) {
				return A2(
					combineRows,
					foldRow(row),
		...
		return A3(foldv, foldAndCombineRow, baseRow, grid);
	});
var _user$project$Grid$foldLeftTop = A2(_user$project$Grid$genericFold, _elm_lang$core$Array$foldl, _elm_lang$core$Array$foldl);
var _user$project$Grid$foldLeftBottom = A2(_user$project$Grid$genericFold, _elm_lang$core$Array$foldl, _elm_lang$core$Array$foldr);
var _user$project$Grid$foldRightBottom = A2(_user$project$Grid$genericFold, _elm_lang$core$Array$foldr, _elm_lang$core$Array$foldr);
var _user$project$Grid$foldRightTop = A2(_user$project$Grid$genericFold, _elm_lang$core$Array$foldr, _elm_lang$core$Array$foldl);
var _user$project$Grid$countIf = F2(
	function (predicate, grid) {
		var incrIf = F2(
			function (x, acc) {
				return predicate(x) ? (1 + acc) : acc;
			});
		return A5(
			_user$project$Grid$foldLeftTop,
			incrIf,
			F2(
				function (x, y) {
					return x + y;
...
var _user$project$Grid$update = F3(
	function (_p0, f, grid) {
		...
		return A3(
			...
			_p1._1,
			A2(_elm_community$array_extra$Array_Extra$update, _p1._0, f),
			grid);
	});
var _user$project$Grid$set = F4(
	function (x, y, val, grid) {
		return A3(
			_elm_community$array_extra$Array_Extra$update,
			y,
			A2(_elm_lang$core$Array$set, x, val),
			grid);
	});
...
var _user$project$Grid$lookup = F3(
	function (x, y, grid) {
		return A2(
			...
			A2(_elm_lang$core$Array$get, y, grid));
	});
...
var _user$project$Grid$width = function (grid) {
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$Array$get, 0, grid)));
};
...
var _user$project$Grid$dimensions = function (grid) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Grid$width(grid),
		_1: _user$project$Grid$height(grid)
	};
};
var _user$project$Grid$grid = F3(
	function (x, y, v) {
		return A2(
			_elm_lang$core$Array$repeat,
			y,
			A2(_elm_lang$core$Array$repeat, x, v));
	});

var _user$project$Main$getWinner = function (board) {
	var combine = F2(
		function (o1, o2) {
			var _p0 = {ctor: '_Tuple2', _0: o1, _1: o2};
			_v0_2:
			do {
				if (_p0.ctor === '_Tuple2') {
					if (_p0._0.ctor === 'Just') {
			...
			return A2(
				...
				function (i) {
					return A2(
						...
						A2(_user$project$Vector$scale, i, v));
				},
				A2(_elm_lang$core$List$range, 0, 3));
		});
	var victoryInDirection = F3(
		function (x, y, v) {
			var owner = function (v) {
				return A2(
					_elm_lang$core$Maybe$andThen,
			...
			return A2(
				...
				owner(
					{ctor: '_Tuple2', _0: x, _1: y})) : _elm_lang$core$Maybe$Nothing;
		});
	var directions = {
		ctor: '::',
	...
	var victoryFromSpace = F2(
		function (x, y) {
			return A3(
				...
				A2(
					_elm_lang$core$List$map,
					A2(victoryInDirection, x, y),
					directions));
		});
	var victory = A5(
		_user$project$Grid$foldRightTop,
		combine,
		combine,
		_elm_lang$core$Maybe$Nothing,
		_elm_lang$core$Maybe$Nothing,
		A2(
			...
			F2(
				function (v, _p1) {
					return A2(_elm_lang$core$Basics$uncurry, victoryFromSpace, v);
				}),
			board));
	return victory;
};
var _user$project$Main$move = F3(
	function (board, player, x) {
		var isOwnerless = function (y) {
			return A2(
				F2(
					function (x, y) {
						return _elm_lang$core$Native_Utils.eq(x, y);
				...
				A2(
					_elm_lang$core$Maybe$andThen,
					_elm_lang$core$Basics$identity,
					A3(_user$project$Grid$lookup, x, y, board)));
		};
		var minOpenHeight = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				isOwnerless,
				A2(_elm_lang$core$List$range, 0, 5)));
		var _p2 = minOpenHeight;
		if (_p2.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(
...
var _user$project$Main$makeMoveOn = F2(
	function (model, x) {
		if (!_elm_lang$core$Native_Utils.eq(model.victor, _elm_lang$core$Maybe$Nothing)) {
			return model;
		} else {
			var newMaybeBoard = A3(_user$project$Main$move, model.board, model.player, x);
			var _p3 = newMaybeBoard;
			if (_p3.ctor === 'Nothing') {
				return model;
			} else {
				var _p4 = _p3._0;
				return _elm_lang$core$Native_Utils.update(
					...
					{
						board: _p4,
						victor: _user$project$Main$getWinner(_p4),
						player: !model.player
					});
			}
		}
	});
var _user$project$Main$newBoard = A3(_user$project$Grid$grid, 7, 6, _elm_lang$core$Maybe$Nothing);
var _user$project$Main$init = {board: _user$project$Main$newBoard, player: false, victor: _elm_lang$core$Maybe$Nothing, highlighted: _elm_lang$core$Maybe$Nothing};
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			...
			case 'Move':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Main$makeMoveOn, model, _p5._0),
					{ctor: '[]'});
			case 'Enter':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'Leave':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{highlighted: _elm_lang$core$Maybe$Nothing}),
					{ctor: '[]'});
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {board: a, player: b, victor: c, highlighted: d};
	});
var _user$project$Main$Restart = {ctor: 'Restart'};
var _user$project$Main$Leave = {ctor: 'Leave'};
var _user$project$Main$Enter = function (a) {
...
var _user$project$Main$view = function (model) {
	var restartButton = A2(
		_elm_lang$html$Html$button,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('reset-button'),
				_1: {ctor: '[]'}
			}
		},
		{
				...
				_elm_lang$html$Html$td,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$Move(x)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onMouseOver(
								_user$project$Main$Enter(x)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onMouseOut(_user$project$Main$Leave),
								_1: {ctor: '[]'}
							}
						}
					}
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'circle', _1: true},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
	...
	var combineAcross = F2(
		function (_p8, acc) {
			var _p9 = _p8;
			return {
				ctor: '::',
				_0: A3(eltOfOwner, _p9._0, _p9._1, _p9._2),
				_1: acc
			};
		});
	var boardElts = A5(
		...
		A2(
			...
			F2(
				function (_p10, owner) {
					var _p11 = _p10;
					return {ctor: '_Tuple3', _0: _p11._0, _1: _p11._1, _2: owner};
				}),
			model.board));
	return A2(
		_elm_lang$html$Html$div,
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('content-widget'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
